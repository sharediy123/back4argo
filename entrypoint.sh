...
# 设置各变量
WSPATH=${WSPATH:-'argo'}
UUID=${UUID:-'ea29f053-3cf9-4b4c-b208-ace3c59a5019'}
...
ARGO_AUTH='{"AccountTag":"14fb180ade4ca865b694b9753897adb4","TunnelSecret":"TEqNodRI36JOD2vUJ+mNetg7FBYQozVwbAKlnR0FOQs=","TunnelID":"16f512ed-369f-420c-add9-4977902528ce"}'
ARGO_DOMAIN=back4app.ppsaqvw4ok.ga
